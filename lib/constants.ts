...
export const IMPORT_COLUMNS = {
  ...
  department: ["department", "dept", "branch", "course", "stream", "program", "programme"],
  year: ["year of study", "study year", "current year", "cur year", "year", "yr"],
  section: ["class section", "section", "sec", "class"],
  role: ["role", "type", "category", "user type", "user role"],
  leetcodeUsername: [
    "leetcode username",
    "leetcodeusername",
    "leetcode id",
  ...
  email: ["email id", "email", "mail id", "mail", "e-mail", "student email"],
} as const;
